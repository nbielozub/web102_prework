...
console.log(filterUnfundedOnly.length); // This will log the number of unfunded games
...
console.log(filterFundedOnly.length); // This will log the number of funded games
// show all games
